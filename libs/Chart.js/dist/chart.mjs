...
class BarController extends DatasetController {
  ...
  _getRuler() {
    ...
    if (opts._context.dataset.setPercentage) {
      totalSize = iScale._endPixel - iScale._startPixel;
      normalSize = pixels[0];
