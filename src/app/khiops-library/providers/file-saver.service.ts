	...
	saveAs(datas) {
		const dialogOpts: any = {
			defaultPath:
				...
				this.khiopsLibraryService.getAppConfig().common.FILE_SAVE
					.EXT_NAME,
			filters: [
				{
					name: this.khiopsLibraryService.getAppConfig().common
						.FILE_SAVE.FORMAT,
					extensions: [
						this.khiopsLibraryService.getAppConfig().common
							.FILE_SAVE.FORMAT,
					],
				},
			],
