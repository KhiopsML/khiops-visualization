...
export class LevelDistributionGraphCanvasComponent extends ScrollableGraphCanvasComponent implements OnInit {
	...
	constructor(private distributionDatasService: DistributionDatasService,
	...
	ngOnInit() {
		...
		// load datas
		this.inputDatas = this.distributionDatasService.getLeveldistributionGraphDatas(this.datas);
