...
import {
	AxisViewComponent
} from './components/axis-view/axis-view.component';
import {
	AxisComponent
} from './components/commons/axis/axis.component';
import {
	ProjectViewComponent
} from './components/project-view/project-view.component';
import {
	HeaderManageViewComponent
} from './components/commons/header-manage-view/header-manage-view.component';
import {
	TreeSelectComponent
} from './components/commons/tree-select/tree-select.component';
import {
	HierarchySelectComponent
} from './components/commons/hierarchy-select/hierarchy-select.component';
import {
	ClusterDetailsComponent
} from './components/commons/cluster-details/cluster-details.component';
import {
	AnnotationComponent
} from './components/commons/annotation/annotation.component';
import {
	CompositionComponent
} from './components/commons/composition/composition.component';
import {
...
} from './components/commons/selected-clusters/selected-clusters.component';
import {
	MatrixContainerComponent
} from './components/commons/matrix-container/matrix-container.component';
import {
	UnfoldHierarchyComponent
} from './components/commons/unfold-hierarchy/unfold-hierarchy.component';
import {
...
} from './components/commons/load-ext-datas/load-ext-datas.component';
import {
	ImportExtDatasComponent
} from './components/commons/import-ext-datas/import-ext-datas.component';
import {
	ImportExtDatasListComponent
} from './components/commons/import-ext-datas-list/import-ext-datas-list.component';
import {
	ManageViewsComponent
} from './components/commons/manage-views/manage-views.component';
import {
	AgGridModule
...
} from './components/commons/external-datas/external-datas.component';
import {
