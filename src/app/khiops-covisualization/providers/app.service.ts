...
export class AppService {
	...
	initViewsLayout(dimensions): ViewLayoutVO {
		...
		if (savedViewsLayout) {
			...
			const lsStorage = localStorage.getItem(AppConfig.common.GLOBAL.LS_ID + 'VIEWS_LAYOUT');
	...
	saveViewsLayout(viewsLayout: ViewLayoutVO) {
		...
		localStorage.setItem(AppConfig.common.GLOBAL.LS_ID + 'VIEWS_LAYOUT', JSON.stringify(this.viewsLayout));
