...
export class TreeSelectComponent extends SelectableComponent
  ...
  constructor(
    ...
    this.treeInitSub = this.eventsService.treeInit.subscribe(
      (selectedNodes) => {
    ...
    this.treeSelectedNodeChangedSub = this.eventsService.treeSelectedNodeChanged.subscribe(
      (e) => {
